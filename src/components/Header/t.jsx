  ...
  return (
    <header className="header">
      <div className='top-menu'>
        <div className='mx-auto flex max-w-7xl items-center justify-between p-2 lg:px-8 top-menu-container'>
          <div className="flex lg:flex-1">
            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
              ...
              <Popover.Group className="hidden lg:flex lg:gap-x-12">
                <Popover className="relative option-style">
                  <Popover.Button className="flex items-center gap-x-1 text-sm font-bold leading-6 uppercase text-slate-100">
                    Product
                ...
                <a href="#" className="text-sm font-bold leading-6 uppercase text-slate-100 option-style">
                  Features
                </a>
                <a href="#" className="text-sm font-bold leading-6 uppercase text-slate-100 option-style">
                  Marketplace
