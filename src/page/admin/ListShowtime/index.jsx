...
const ListShowtime = () => {
  ...
  console.log("🚀 ~ ListShowtime ~ dateTime:", dateTime)
                    ...
                    <div className=''>
                        ...
                        </table>
                      {
                        !cinemaId ?
                            ...
                            <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-16 mx-4'>
                              {
                                allCinema.map((item, index) => (
                                  <div
                                    key={`cinema-${index}`}
                                    className='bg-slate-700 sm:w-80 md:w-[260px] lg:w-64 flex flex-col justify-between'
                                    onClick={() => { changeTab(`/admin/list-showtime/${item.cinemaId}`) }}
                                  >
                          ...
                          <>
                            {/^\/(admin|manager)\/list-showtime\/cinema/.test(pathname) && <DetailShowtime showtimeId={showtimeId} dateTime={dateTime} />}
                            <ShowtimesByRoom />
                          </>
                      }
